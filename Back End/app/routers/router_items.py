...
from repo_selector import current_item_repo
from repositories.repository_interface.repo_items import ItemRepo
from models.models_items import ItemModel, UpdateItemBase, ItemBase
...
async def create_item(item: ItemBase, repository: ItemRepo = Depends(current_item_repo)):
...
async def update_item(item_id: int, item_update: UpdateItemBase, repository: ItemRepo = Depends(current_item_repo)):
